  ...
  _submitEvent()async{
    if (_formKey.currentState.validate()) {
      if(backgroundImage!=null) {
        await DatabaseManager().uploadImageToStorage(
            this.uid, this.backgroundImage);
          ...
          children: <Widget>[
            TextFormField(
              ...
              decoration: const InputDecoration(
                hintMaxLines: 3,
                hintText: 'First three letters for premise, next three for event name and 2 digit number for serial id',
                labelText: 'Uid',
              ),
              ...
              validator: (String value) {
                return value==null || value.isEmpty ? 'Do not use the @ char.' : null;
              },
            ),
            TextFormField(
              onChanged: (text) {
            ...
            Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: <Widget>[
                  GestureDetector(onTap: () => _selectStartDate(context),child:  Text("Start date")),
            ...
            Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: <Widget>[
                  GestureDetector(onTap: () => _selectEndDate(context),child:  Text("End date")),
            ...
            Container(
                ...
                child:
            GestureDetector(onTap: _submitEvent,child: Text("Create",style: TextStyle(fontSize: 20),))),
          ],
        )));
  }
}
